...
class AboutSettings(ft.Container):
    ...
    def __init__(self, page: ft.Page):
        ...
        self._CARD_CONTENT: list[tuple[ft.Icons, str, str]] = [
                        ...
                        controls = [
                            ft.Container(
                                ...
                                content = ft.CircleAvatar(
                                    ...
                                    content = ft.Image(
                                        src = r'assets\images\about\proposta.png',
                                        fit = ft.ImageFit.COVER,
                                        border_radius = ft.border_radius.all(100)
                                    )
                                )
                            ...
                            ft.Column(
                                ...
                                controls = [
                                    self._create_texts(
                                        text = 'Qual a Finidade?',
                                        text_color = color.branco,
                                        weight = ft.FontWeight.BOLD,
                                        size = 30
                                    ),
                                    self._create_texts(
                                        text = 'Pulse Music — nostalgia de um player clássico com recursos modernos.',
                                        text_color = color.branco,
                                        weight = ft.FontWeight.W_400,
                                        size = 18,
                                        max_lines = 4,
        ...
        self.footer = ft.Container(
            ...
            content = ft.Column(
                ...
                controls = [
                    self._create_texts(
                        text = 'Pulse Music: a nostalgia do player clássico reinventada.',
                        text_color = color.branco,
                        weight = ft.FontWeight.W_400,
                        size = 20,
                        max_lines = 2
                    ...
                    ft.Row(
                        ...
                        controls = [
                            self._create_texts(
                                text = '© 2025 Pulse Music. Software desenvolvido para fins acadêmicos.',
                                text_color = color.branco,
    ...
    def _create_cards(
        ...
        return ft.Container(
            ...
            gradient = ft.LinearGradient(
                ...
                # color = ["#293041", "#1a1d29"]
                colors = [color.preto_puro_4, ft.Colors.with_opacity(1, color.preto_puro_5), ft.Colors.with_opacity(1, color.preto_puro_5), color.preto_puro_4]
            ),

...
class SettingsSobre(ft.Container):
    def __init__(self, page):
        ...
        self.DICAS = [
            ('Já tentou expandir o player? Às vezes a melhor parte está escondida 🫣.', cor.preto_cinza),
            ('Favoritar músicas não é só decoração — facilita a sua vida depois 😉', cor.preto_cinza),
            ('Se a música tiver letra... não se sinta envergonhado de cantá-la 🎶 (mesmo que errado 😅)', cor.preto_cinza),
            ('A LUNA não morde viu 😜? Pode conversar com player... você vai gostar 😉!', cor.preto_cinza),
            ('Não quer niguém de atormentando 🙄? Crie as suas playlists!', cor.preto_cinza),
            ('Cada conta tem seu espaço. Nem todo mundo precisa ouvir o mesmo gosto musical 😑', cor.preto_cinza),
            ('Procurar música no navegador é coisa do passado... 🖥️', cor.preto_cinza),
            ('Eaí já foi ver os artistas que você ouve? Não? Ta esperando o que? 🤨', cor.preto_cinza),
            ('Ei tu gosta de ver as músicas de cada álbum? Aqui gosto não importa e sim sua diversão! Vai lá ver 😉.', cor.preto_cinza),
            ('Ei! Aumenta o VOLUME aí, essa música é boa... 😌', cor.preto_cinza),
            ('Precisa de ajuda??? Calma! Não é o fim do mundo! vá ao suporte!', cor.preto_cinza),
            ('Tem preguiça de clicar em botões? Aqui a LUNA faz por você! Ah, não vire um preguiçoso, ok?', cor.preto_cinza)
        ]
                                    ...
                                    ft.IconButton(
                                        ...
                                        style = ft.ButtonStyle(
                                            color = {
                                                ...
                                                ft.ControlState.HOVERED : cor.roxo
                                            },
                                            bgcolor = {
                                                ft.ControlState.DEFAULT : ft.Colors.TRANSPARENT,
                                                ft.ControlState.HOVERED : cor.branco3
                                            }
                                        )
                                    ),
                                    ft.IconButton(
    ...
    def _criar_cards(self, icon, titulo, texto):
        return ft.Container(
            ...
            gradient = ft.LinearGradient(
                ...
                colors = [cor.preto_puro_4, ft.Colors.with_opacity(1, cor.preto_puro_5), ft.Colors.with_opacity(1, cor.preto_puro_5), cor.preto_puro_4]
            ),
    ...
    def atualizar_dica(self, *_):
        ...
        for icon in self.row_icons.controls:
            icon.color = cor.amarelo4 if icon.data == indice else cor.branco

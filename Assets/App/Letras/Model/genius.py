...
class Genius(lyricsgenius.Genius):
    def __init__(
        ...
        super().__init__(access_token, response_format, timeout, sleep_time, verbose, remove_section_headers, skip_non_songs, excluded_terms, replace_default_terms, retries, user_agent, proxy)